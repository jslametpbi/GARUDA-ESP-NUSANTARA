...
function adminLogin(){
  ...
  if(pin!==ADMIN_PIN) return toast("Admin PIN incorrect","Use JS2026.");
...
const navs={
  student:[["dashboard","🏠","Student Dashboard"],["weeks","🗓️","16-Week Studio"],["materials","📚","ESP Materials"],["disciplines","🧭","ESP Disciplines"],["atlas","🗺️","Nusantara Atlas"],["online","📹","Online Room"],["voice","🎙️","Speaker Lab"],["assignments","📝","Assignments"],["portfolio","🏅","Portfolio"],["forum","💬","Forum"],["helpdesk","🛟","Help Desk"]],
  lecturer:[["dashboard","🏠","Lecturer Dashboard"],["builder","🛠️","Course Builder"],["materials","📚","ESP Materials"],["tasks","📝","Tasks & Assessments"],["online","📹","Online Room"],["review","✅","Review Submissions"],["analytics","📊","Learning Analytics"],["forum","💬","Forum"],["helpdesk","🛟","Help Desk"],["ai","🤖","AI-Assisted Studio"]],
  admin:[["dashboard","🏠","Admin Dashboard"],["students","🎓","Student Dashboard"],["lecturers","👨‍🏫","Lecturer Dashboard"],["users","👥","Users & Institutions"],["materials","📚","ESP Materials"],["content","🗂️","Content Control"],["online","📹","Online Room"],["analytics","📊","System Analytics"],["settings","⚙️","System Settings"],["forum","💬","Forum"],["chat","💭","Chat"],["helpdesk","🛟","Help Desk"],["ai","🤖","AI-Assisted Studio"]]
};
...
function renderOnlineRoom(){
  ...
  byId("mainView").innerHTML=`<section class="panel"><h3>Online Room Mode</h3><p>Zoom-like room support for live video links, agenda, host, attendance, screen sharing, chat, breakout discussion, consultation, and assessment feedback.</p></section>${manager?roomCreator():""}<div class="grid cols-2">${rooms.map(r=>roomCard(r)).join("")}</div>`;
}
